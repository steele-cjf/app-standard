...
import { Header, Body, Title, Button, Footer, FooterTab, Icon, Text } from 'native-base';
...
export default class MapScreen extends Component {
  render() {
    return (
      <ScrollView>
        <Header>
          <Body onPress={() => this.props.navigation.goBack()}><Title>百度地图</Title></Body>
        </Header>
        <MapView
